...
namespace ti
{
	...
	HBITMAP BitmapUtils::ScaleBitmap(HBITMAP hBmp, WORD wNewWidth, WORD wNewHeight)
	{
		BITMAP bmp;
	...
	BITMAPINFO *BitmapUtils::PrepareRGBBitmapInfo(WORD wWidth, WORD wHeight)
	{
	...
	float *BitmapUtils::CreateCoeff(int nLen, int nNewLen, BOOL bShrink)
	{
		int nSum = 0, nSum2;
...
#define F_DELTA		0.0001f
	...
	void BitmapUtils::ShrinkData(BYTE *pInBuff, 
		WORD wWidth, 
		WORD wHeight,
		BYTE *pOutBuff, 
		WORD wNewWidth, 
	...
	void BitmapUtils::EnlargeData(BYTE *pInBuff, 
		WORD wWidth, 
		WORD wHeight,
		BYTE *pOutBuff, 
		WORD wNewWidth, 
