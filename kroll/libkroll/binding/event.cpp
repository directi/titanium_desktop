...
namespace kroll
{
	...
	void Event::SetEventConstants(KObject* target)
	{
		...
		// @tiproperty[String, ACTIVATE, since=0.9] The ACTIVATE
		// @tiproperty[String, CLICKED, since=0.9] The Tray Icon Clicked. 
		// @tiproperty[String, DOUBLE_CLICKED, since=0.9] The Tray Icon Double Clicked.
		// @tiproperty[String, DOCK_ICON_CLICKED, since=0.9] The Dock-icon clicked event constant.
